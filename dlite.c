 ...
 *
 * $Id: dlite.c,v 1.1.1.1 2001/08/10 14:58:21 karu Exp $
 *
 * $Log: dlite.c,v $
 ...
 *
 * Revision 1.2  2000/04/10 23:46:28  karu
...
#define MOD_QWORD	0x0008		/* q - print a quadword */
  ...
  *q = '\0';
  ...
  for (i=0, arg_cnt=0; i<MAX_ARGS && cmd->arg_strs[i] != NULL; i++, arg_cnt++)
	...
	case 'a':
	  ...
	  if (eval_error)
	    return (char*) eval_err_str[eval_error];
