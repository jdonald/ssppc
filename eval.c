 ...
 *
 * uhh, isn't this called eval.c? /jdonald
 *
 ...
 *
 * $Id: eval.c,v 1.1.1.1 2001/08/10 14:58:21 karu Exp $
 *
 * $Log: eval.c,v $
...
#include <stdlib.h>
#include <ctype.h>
#if defined(__CYGWIN32__) || defined(linux)
#include <errno.h>
#endif
...
const char *eval_err_str[ERR_NUM] = { // const jdonald
  /* ERR_NOERR */	"!! no error!!",
...
// jdonald not setting these to __thread since expression evaluation only happens at startup
...
const char *eval_type_str[et_NUM] = { // jdonald const
  /* et_int */		"int",
