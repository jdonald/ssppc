 ...
 *
 * $Id: eval.h,v 1.1.1.1 2001/08/10 14:58:21 karu Exp $
 *
 * $Log: eval.h,v $
...
extern const char *eval_err_str[ERR_NUM]; // const jdonald
...
enum eval_type_t {
  ...
  et_qword,			/* unsigned quadword length integer result */
  et_sqword,			/* signed quadword length integer result */
...
extern const char *eval_type_str[et_NUM]; // jdonald const
...
struct eval_value_t {
  ...
  union {
    ...
    sqword_t as_sqword;			/* value for type == ec_squad */
#endif /* HOST_HAS_QWORD */
