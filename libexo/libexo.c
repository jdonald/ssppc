 ...
 *
 * $Id: libexo.c,v 1.1.1.1 2001/08/10 14:58:24 karu Exp $
 *
 * $Log: libexo.c,v $
 * Revision 1.1.1.1  2001/08/10 14:58:24  karu
 ...
 *
 *
 * Revision 1.1.1.1  2001/08/08 21:28:54  karu
 * creating ss3ppc linux repository
 *
 * Revision 1.2  2000/04/10 23:46:47  karu
 ...
 *
 * Revision 1.1.1.1  2000/03/07 05:15:20  karu
 ...
 *
 * Revision 1.1.1.1  2000/02/25 21:02:56  karu
...
const char *exo_class_str[ec_NUM] = { // const jdonald
  "integer",
  "address",
  "float",
  "char",
...
static __thread int token_id = TOKEN_BOGON + 1; // jdonald: i thought i did this already?

#define TOKEN_HASH_SIZE		1024
__thread struct exo_token_t *token_hash[TOKEN_HASH_SIZE];
...
extern __thread char *yytext; // jdonald
extern __thread FILE *yyin; // jdonald

static void
exo_err(char *err)
{
  extern __thread int line; // a tough one to find /jdonald
...
exo_read(FILE *stream)
{
  ...
  switch (tok)
	...
	// char* tmp; // jdonald
	// made the above variable then commented it out. As far as I can
	// tell functions like strtod() or strtol() should be reentrant,
	// unlike strtok() /jdonald
