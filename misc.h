 ...
 *
 * $Id: misc.h,v 1.1.1.1 2001/08/10 14:58:22 karu Exp $
 *
 * $Log: misc.h,v $
...
// #ifdef TARGET_X86
// jdonald: ideal_bop, debug_trace, and other things taken from ss-x86-sel/misc.h
// We can't use #ifdef TARGET_X86, since misc.h is always included before machine.h

/* debugging trace flag */
extern int debug_callgraph;

/* debugging trace flag */
extern int debug_trace;

/* debugging trace with registers flag */
...
extern int watch_mem;

/* memory watch addresses, 0 == not activated */
extern unsigned int watch_byte;
extern unsigned int watch_half;
extern unsigned int watch_word;
extern unsigned int watch_qword;

extern int ideal_bop; // skumar
...
#ifdef __GNUC__
/* declare a oneshot warning */ // jdonald: taken from ss-x86-sel/misc.h
...
// jdonald: changed the above to use const char instead of char
// this warning didn't surface until someone used info() from target-x86!
#else /* !__GNUC__ */
void
info(char *fmt, ...);
#endif /* !__GNUC__ */
