 ...
 *
 * $Id: options.h,v 1.1.1.1 2001/08/10 14:58:22 karu Exp $
 *
 * $Log: options.h,v $
...
#ifdef HOST_HAS_QWORD // for opt_reg_sqword
	// oc = oc_sqword
	struct opt_for_sqword_t {
	  sqword_t* var; // pointer to sqword
    } for_sqword;
