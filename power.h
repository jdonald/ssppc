...
// #define TECH_POINT35 // 35 nm
#define TECH_POINT032 // 32 nm

#if defined(TECH_POINT032) // only this one is 'calibrated' to make realistic tempreatures. However, the capacitance and such numbers don't make much sense from a theoretical perspective
#define CSCALE		15000
#define RSCALE		280
#define LSCALE		0.04375
#define ASCALE		(LSCALE*LSCALE)
#define VSCALE		0.19 // 0.95 V
#define VTSCALE		0.21 // ?
#define SSCALE		0.68
#define GEN_POWER_SCALE (1/GEN_POWER_FACTOR/GEN_POWER_FACTOR/1.2) // still pessimistic power scaling

#elif defined(TECH_POINT035) // minor scale down from TECH_POINT045
//#define CSCALE		280 // other new device technologies may play a key role here
#define CSCALE		10000
#define RSCALE		240
#define LSCALE		0.04375
#define ASCALE		(LSCALE*LSCALE)
...
#elif defined(TECH_POINT045) // major scale down from TECH_POINT065
//#define CSCALE		200 // other new device technologies may play a key role here
#define CSCALE 700
#define RSCALE		180
#define LSCALE		0.05625
#define ASCALE		(LSCALE*LSCALE)
#define VSCALE		0.20 // 1.0 V
#define VTSCALE		0.22 // ?
#define SSCALE		0.70
#define GEN_POWER_SCALE (1/GEN_POWER_FACTOR/GEN_POWER_FACTOR/1.1) // pessimistic power scaling

#elif defined(TECH_POINT065) // major scale down from TECH_POINT100
//#define CSCALE		130 // high-k dielectric, silicon-on-insulator, and other
#define CSCALE 250
#define RSCALE		120 // materials changes could change these significantly.
#define LSCALE		0.08125
#define ASCALE		(LSCALE*LSCALE)
#define VSCALE		0.22 // 1.1 V
#define VTSCALE		0.25 // ?
#define SSCALE		0.75
#define GEN_POWER_SCALE (1/GEN_POWER_FACTOR/GEN_POWER_FACTOR)

#elif defined(TECH_POINT070) // minor scale up from TECH_POINT065
//#define CSCALE		120 // high-k dielectric, silicon-on-insulator, and other
#define CSCALE 200
#define RSCALE		110 // materials changes could change these significantly.
#define LSCALE		0.0875
#define ASCALE		(LSCALE*LSCALE)
#define VSCALE		0.23 // 1.15 V
#define VTSCALE		0.26 // ?
#define SSCALE		0.76
#define GEN_POWER_SCALE (1/GEN_POWER_FACTOR/GEN_POWER_FACTOR*1.1)

#elif defined(TECH_POINT090) // minor scale down from TECH_POINT10
#define CSCALE		88
#define RSCALE		84
#define LSCALE		0.1125
#define ASCALE		(LSCALE*LSCALE)
#define VSCALE		0.24 // 1.2 V, a big drop from the 1.9 V used in 100 nm
#define VTSCALE		0.27 // ?
#define SSCALE		0.78
#define GEN_POWER_SCALE (1/GEN_POWER_FACTOR/GEN_POWER_FACTOR/1.1)
...
#define Vdd		(5 * VSCALE) // todo: set to a realistic voltage, 5 V is too high /jdonald

/* other stuff (from tech report, appendix 1) */

#define Mhz             600e6 // todo: sync with hotspot base_proc_freq /jdonald
#define Period          (1.0/Mhz)
...
#define DEFAULT_AF    .5
// jdonald has renamed AF to DEFAULT_AF to avoid conflicting with
// a variable in target-x86/x86.h
...
#ifdef TARGET_X86 // jdonald: it seems the x86 power.h has a wide variety of new modifications, such as:

enum {
  CONTROL_SCOPE_NONE = 0x0,
  CONTROL_SCOPE_FUNC_ONLY = 0x1,
  CONTROL_SCOPE_MEM_ONLY = 0x2,
  CONTROL_SCOPE_FRONT_ONLY = 0x4,
  CONTROL_SCOPE_FUNC = 0x1,
  CONTROL_SCOPE_EXEC = 0x3,
  CONTROL_SCOPE_CORE = 0x7
};

#define CONTROL_FREEZE_FUNC  (CONTROL_SCOPE_FUNC_ONLY & control_freeze)
#define CONTROL_FREEZE_MEM   (CONTROL_SCOPE_MEM_ONLY & control_freeze)
#define CONTROL_FREEZE_FRONT (CONTROL_SCOPE_FRONT_ONLY & control_freeze)


struct pipe_rec* pipe_rec_init(int depth, int width, double energy, int buffer, int pipelined, int controlled);
...
enum {
  EVENT_TRACKER_MPRED = 0,
  EVENT_TRACKER_LONG,
  EVENT_TRACKER_IL1_MISS,
  EVENT_TRACKER_IL1_FILL,
  EVENT_TRACKER_DL1_MISS,
  EVENT_TRACKER_DL1_FILL,
  EVENT_TRACKER_UL2_MISS,
  EVENT_TRACKER_UL2_FILL,
  EVENT_TRACKER_NUM_EVENTS
};

extern int *current_event_count;
