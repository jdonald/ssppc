 ...
 *
 * $Id: symbol.h,v 1.1.1.1 2001/08/10 14:58:23 karu Exp $
 *
 * $Log: symbol.h,v $
...
extern __thread struct sym_sym_t *sym_db;

/* all symbol sorted by address */
extern __thread int sym_nsyms;
extern __thread struct sym_sym_t **sym_syms;

/* all symbols sorted by name */
extern __thread struct sym_sym_t **sym_syms_by_name;

/* text symbols sorted by address */
extern __thread int sym_ntextsyms;
extern __thread struct sym_sym_t **sym_textsyms;

/* text symbols sorted by name */
extern __thread struct sym_sym_t **sym_textsyms_by_name;

/* data symbols sorted by address */
extern __thread int sym_ndatasyms;
extern __thread struct sym_sym_t **sym_datasyms;

/* data symbols sorted by name */
extern __thread struct sym_sym_t **sym_datasyms_by_name;
