 ...
 *
 * $Id: alpha.c,v 1.1.1.1 2001/08/10 14:58:24 karu Exp $
 *
 * $Log: alpha.c,v $
 ...
 *
 * Revision 1.2  2000/04/10 23:46:50  karu
...
const md_inst_t MD_NOP_INST = 0x43ff041f;		/* addq r31,r31,r31 */
	      ...
	      FILE *stream)		/* output stream */
{
  ...
  if (op <= OP_NA || op >= OP_MAX)
    ...
    {
      const char *s; // jdonald: made tthis a const string, since it always is!
