 ...
 *
 * $Id: alpha.h,v 1.1.1.1 2001/08/10 14:58:24 karu Exp $
 *
 * $Log: alpha.h,v $
 ...
 *
 * Revision 1.2  2000/04/10 23:46:51  karu
...
typedef union {
  qword_t q[MD_NUM_FREGS];	/* integer quad view */
  dfloat_t d[MD_NUM_FREGS];	/* double-prediction floating point view */
} md_fpr_t;
...
// jdonald: moved the above enum declaration to before md_mask2op, otherwise gcc 4 complains
