 ...
 *
 * $Id: symbol.c,v 1.1.1.1 2001/08/10 14:58:24 karu Exp $
 *
 * $Log: symbol.c,v $
 ...
 *
 *
 * Revision 1.1.1.1  2001/08/08 21:28:55  karu
...
__thread struct sym_sym_t *sym_db = NULL;

/* all symbol sorted by address */
__thread int sym_nsyms = 0;
__thread struct sym_sym_t **sym_syms = NULL;

/* all symbols sorted by name */
__thread struct sym_sym_t **sym_syms_by_name = NULL;

/* text symbols sorted by address */
__thread int sym_ntextsyms = 0;
__thread struct sym_sym_t **sym_textsyms = NULL;

/* text symbols sorted by name */
__thread struct sym_sym_t **sym_textsyms_by_name = NULL;

/* data symbols sorted by address */
__thread int sym_ndatasyms = 0;
__thread struct sym_sym_t **sym_datasyms = NULL;

/* data symbols sorted by name */
__thread struct sym_sym_t **sym_datasyms_by_name = NULL;

/* symbols loaded? */
static __thread int syms_loaded = FALSE;
