 ...
 *
 * $Id: syscall.c,v 1.1.1.1 2001/08/10 14:58:24 karu Exp $
 *
 * $Log: syscall.c,v $
 ...
 *
 * Revision 1.2  2000/04/10 23:46:54  karu
...
#if defined(linux) || defined(__CYGWIN__)
//#include <bsd/sgtty.h>
// commenting out this bsd/sgtty.h as instructed in README.decstation
// /jdonald
...
__thread qword_t sigmask = 0;

__thread qword_t sigaction_array[OSF_NSIG] =
...
#error No utimes() implementation!
	...
	qword_t pbuf = regs->regs_R[MD_REG_A1];
	word_t nbytes = regs->regs_R[MD_REG_A2];
	qword_t pbase = regs->regs_R[MD_REG_A3];
	struct dirent *buf;
	long base = 0;
	sqword_t sbase;
	...
	char *buf;
	word_t osf_addrlen;
	socklen_t addrlen; // jdonald: changing int addrlen to socklen_t addrlen
	...
	char *buf;
	word_t osf_addrlen;
	socklen_t addrlen; // jdonald: changing this type from int to socklen_t as well
