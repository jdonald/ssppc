...
#if XXX // jdonald: noticed the only place using this variable is blocked out with #if XXX
/* symbols loaded? */
...
#if XXX // jdonald: these functions were only used in an 'XXX' part as well
