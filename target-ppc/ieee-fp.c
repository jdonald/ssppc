...
#define SET_FPSCR_FX_VAL(E)         (E=(E|0x8000000000000000))
#define SET_FPSCR_UX_VAL(E)         (E=(E|0x0800000000000000))
#define SET_FPSCR_OX_VAL(E)         (E=(E|0x1000000000000000))
#define RESET_FPSCR_FR_VAL(E)       (E=(E&0xfffbffffffffffff))
#define RESET_FPSCR_FI_VAL(E)       (E=(E&0xfffdffffffffffff))
#define SET_FPSCR_FR_VAL(E)         (E=(E|0x0004000000000000))
#define SET_FPSCR_FI_VAL(E)         (E=(E|0x0002000000000000))
#define SET_FPSCR_XX_VAL(E)         (E=(E|0x0200000000000000))
#define SET_FPSCR_VXISI_VAL(E)      (E=(E|0x0080000000000000)) 
#define SET_FPSCR_VXSNAN_VAL(E)     (E=(E|0x0100000000000000)) 
#define SET_FPSCR_VXIMZ_VAL(E)      (E=(E|0x0010000000000000)) 
#define SET_FPSCR_VXIDI_VAL(E)      (E=(E|0x0040000000000000)) 
#define SET_FPSCR_VXCVI_VAL(E)      (E=(E|0x0000000000000100)) 
#define SET_FPSCR_FPRF_VAL(E,V)     (E=((E&0xfffffffffffe0fff)|((V&0x1f)<<12)))
...
{
	unsigned long long carry = a[0] > (0xffffffffffffffff - b[0]);
...
void setFPSCRFPRFFlags(unsigned long long b, unsigned int *pi)
{
  if(b&0x8000000000000000){
    ...
    if(((b&0x7ff0000000000000)==0)&&((b&0x000fffffffffffff)!=0)){
      /*-DENORM*/
    ...
    if(((b&0x7ff0000000000000)==0x7ff0000000000000)&&((b&0x0008000000000000)!=0)){
      /*NaN*/
      SET_FPSCR_FPRF_VAL(*pi,0x11);
      return;
    } 
