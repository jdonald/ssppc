...
//  double l = 0.1525; // jdonald unused
...
double diffArea;
double diffPeri;
// double l = 0.4 * LSCALE; // jdonald unused
...
#else // jdonald changing this to make sense
...
// double *Tdecdrive,*Tdecoder1,*Tdecoder2,*outrisetime;
{
        ...
        int numstack;
		double z = 0.0;
        // double tstep,m,a,b,c; // jdonald unused
...
// double inrisetime,*outrisetime;
{
		...
		// double Req, nextrisetime; // jdonald unused
...
// time_parameter_type *parameters;
{
   ...
   double outrisetime,inrisetime;
   // double driver_cap; // jdonald unused
   // double tag_driver_size1,tag_driver_size2; // jdonald unused
