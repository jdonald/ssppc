...
int res_memport;
int verbose;
__thread int rename_access, window_access, bpred_access, lsq_access, regfile_access;
__thread int irename_access, frename_access; // jdonald
__thread int iregfile_access, fregfile_access; // jdonald
__thread int icache_access, dcache_access, dcache2_access, alu_access, resultbus_access;
__thread int window_preg_access, window_selection_access;
__thread int lsq_wakeup_access, lsq_preg_access, ialu_access, falu_access;
__thread int window_wakeup_access, lsq_store_data_access, lsq_load_data_access;
__thread int window_total_pop_count_cycle, window_num_pop_count_cycle;
__thread int lsq_total_pop_count_cycle, lsq_num_pop_count_cycle;
__thread int regfile_total_pop_count_cycle, regfile_num_pop_count_cycle;
__thread int resultbus_num_pop_count_cycle, resultbus_total_pop_count_cycle;

int ras_size;

__thread struct cache_t *cache_dl1;
__thread struct cache_t *cache_il1;
struct cache_t *cache_dl2; // not __thread /jdonald
__thread struct cache_t *dtlb;
__thread struct cache_t *itlb;
...
int main()
{
  ...
  // double regfile_power, regfile_decoder, regfile_wordline, regfile_wordline16, regfile_wordline33, regfile_bitline; // jdonald unused

  // int scale_factor; // jdonald unused
  int data_width;
  int rports, wports;
